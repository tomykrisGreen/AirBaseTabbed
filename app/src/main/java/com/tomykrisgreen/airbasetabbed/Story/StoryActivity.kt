...
class StoryActivity : AppCompatActivity(), StoriesProgressView.StoriesListener {
    ...
    var progressBarStory: ProgressBar? = null
...
//        }
        ...
        //seen_number replaced with layout_seen for more touch response
    ...
    private fun getStories(userId: String) {
        progressBarStory!!.visibility = View.VISIBLE
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (snapshot in p0.children) {
                    ...
                    if (timeCurrent > story!!.getTimeStart() && timeCurrent < story.getTimeEnd()) {
                        ...
                        progressBarStory!!.visibility = View.GONE
                    }
                }
    ...
    private fun userInfo(storyId: String) {
        ...
        usersRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (p0.exists()) {
                    ...
                    story_username.text = user.getName()
                }
            }
