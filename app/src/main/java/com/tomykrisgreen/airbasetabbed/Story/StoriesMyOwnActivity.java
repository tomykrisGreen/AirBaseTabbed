...
public class StoriesMyOwnActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stories_my_own);
    ...
    public void onComplete() {
        ...
        Intent i = new Intent(StoriesMyOwnActivity.this, MainActivity.class);
        startActivity(i);
        finish();
    }
