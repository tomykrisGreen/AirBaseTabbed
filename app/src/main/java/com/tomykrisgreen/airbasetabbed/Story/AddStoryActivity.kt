...
import com.tomykrisgreen.airbasetabbed.DashboardActivity
    ...
    private fun uploadStory() {
        when
        {
            imageUri == null -> Toast.makeText(this, "Please select an image", Toast.LENGTH_LONG).show()
                ...
                progressDialog.setMessage("Please wait, uploading your story...")
                progressDialog.show()
                    ...
                    return@Continuation fileRef.downloadUrl
                        ...
                        .addOnCompleteListener (OnCompleteListener<Uri> { task ->
                            if (task.isSuccessful)
                            {
                                ...
                                val timeEnd = System.currentTimeMillis() + 86400000  // displaying story for only 24 hours

                                val storyMap = HashMap<String, Any>()
                                storyMap["uid"] = FirebaseAuth.getInstance().currentUser!!.uid
                                ...
                                Toast.makeText(this, "Story update successful", Toast.LENGTH_LONG).show()
