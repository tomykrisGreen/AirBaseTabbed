...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        /* Now there are two types of notification
        ...
        if (notificationType.equals("PostNotification")){
            ...
            // If user is same that posted, don't show notification
    ...
    private void showPostNotification(String pId, String pTitle, String pDescription) {
        ...
        Lets add check if if version is Oreo or higher, then, setup notification channel
         */
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
